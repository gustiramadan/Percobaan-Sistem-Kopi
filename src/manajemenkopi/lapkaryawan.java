...
Connection koneksi;
    ...
    {
        String[] kolom = {"NO","ID_Karyawan","NIK","Nama_Karyawan","Jenis_Kelamin","Tgl_Masuk","Tempat_Lahir","Tgl_Lahir","Pend_Terakhir","Usia","Alamat"};
    ...
    private void initComponents() {
        ...
        cetakPegawai = new javax.swing.JButton();
        ...
        cetakPegawai.setBackground(new java.awt.Color(51, 204, 255));
        cetakPegawai.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        cetakPegawai.setText("Cetak laporan");
        cetakPegawai.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cetakPegawaiActionPerformed(evt);
            }
        });
        ...
        tkaryawan.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "no", "id_karyawan", "NIK", "Nama_karyawan", "jenis_kelamin", "tanggal_masuk", "tempat_lahir", "tanggal_lahir", "pendidikan_terakhit", "usia", "alamat", "jabatan", "status", "agama", "kontak"
            }
        ));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(cetakPegawai, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(bexport, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(bprint)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(cetakPegawai, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        //   String nik = tkaryawan.getValueAt(baris, 1).toString();
    ...
    private void bprintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bprintActionPerformed
               try {
    boolean complete = tkaryawan.print();
    if (complete) 
    {
    ...
    private void cetakPegawaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetakPegawaiActionPerformed
        String reportSource = null;
        String reportDest = null;
        
        try{
            com.mysql.jdbc.Connection c = (com.mysql.jdbc.Connection) koneksi;
            reportSource = System.getProperty("user.dir") + "/laporan/Laporan_Pegawai.jrxml";
            reportDest = System.getProperty("user.dir") + "/laporan/Laporan_Pegawai.jasper";
    ...
    private void export(){
        ...
        if (retrival == JFileChooser.APPROVE_OPTION) {
            ...
            try{
                ...
                TableModel tModel = tkaryawan.getModel();
    ...
    private javax.swing.JButton cetakPegawai;
