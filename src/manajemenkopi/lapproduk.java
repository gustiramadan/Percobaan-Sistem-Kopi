...
public class lapproduk extends javax.swing.JFrame {
Connection koneksi;
    /**
     * Creates new form lapproduk
     */
    public lapproduk() {
        initComponents();
    ...
    {
        String[] kolom = {"NO","id_produk","nama_produk","harga_produk","jumlah_produk","stok_produk","status_produksi"};
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                dtm.addRow(new String[]{no + "",id_produk,nama_produk,harga_produk,jumlah_produk,stok_produk,status_produksi});
                no++;
            }
    ...
    private void initComponents() {
        ...
        tproduk.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NO", "id_produk", "Nama_produk", "harga_produk", "jumlah_produk", "stok_produk", "status_produksi"
            }
        ));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(bedit, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(bexport, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void bprintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bprintActionPerformed
               try {
    boolean complete = tproduk.print();
    if (complete) 
    {
    ...
    private void bdropActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bdropActionPerformed
        ...
        try{
            ...
            reportSource = System.getProperty("user.dir") + "/laporan/laporan_produkkopi.jrxml";
...
int baris;
    private void tprodukMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tprodukMouseClicked
        ...
        if (retrival == JFileChooser.APPROVE_OPTION) {
            ...
            try{
                ...
                TableModel tModel = tproduk.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lapproduk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
